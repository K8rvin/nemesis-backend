...
INSERT INTO public.nodes (
  ...
  'Кабина шаттла',
  'ПОСЛЕДНИЙ ПРИКАЗ',
  'Ты тащишь Тобиаса в разрушенную кабину шаттла. За иллюминаторами — последние вспышки плазмы и рев тварей. Враг ломится с кормы, и времени на раздумья нет. «Тобиас, прикрой меня», — говоришь ты. Он кивает, хрипло выдыхает, поднимает ствол. Выстрелы. Крик. Шквальный огонь накрывает кабину; несколько пул пронзает твоё плечо, но большую часть заряда принимает на себя Тобиас. Когда ты добираешься до панели запуска, он уже на полу, смертельно раненый, но всё ещё дышит. Ты подхватываешь его под руку и тащишь к выходу. Шаттл отрывается. Тобиас не шевелится.',
...
INSERT INTO public.choices (
  ...
  '{"unlock_achievement": "ach_no_man_left_behind_bad", "add_flag": "tobias_mortally_wounded", "set_hp": 15}'::jsonb,
  5
)
ON CONFLICT (id) DO UPDATE SET
