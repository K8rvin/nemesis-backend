-- Обновляем выбор ach_speedrun: переносим в act1_hub_junk, требуем флаг получения лома.
-- Флаг "нашел_лом" ставится при успешном прохождении мини-игры за лом.
UPDATE public.choices
SET
  node_id = 'act1_hub_junk',
  label = '🔨 Ударить ломом по ржавой трубе',
  conditions = '{"flag_required":"нашел_лом"}',
...
INSERT INTO public.achievement_routes (
  ...
  'act1_start',
  'ach_speedrun',
  '["ch_1_start_to_skills", "trans_choice_ch_1_start_to_skills", "ch_1_skill_eng", "trans_choice_ch_1_skill_eng", "ch_1_hub_to_explore", "trans_choice_ch_1_hub_to_explore", "ch_1_explore_to_junk", "trans_choice_ch_1_explore_to_junk", "ch_1_hub_loot_crowbar", "trans_choice_ch_1_hub_loot_crowbar", "ch_1_hub_fast_death"]'::jsonb,
